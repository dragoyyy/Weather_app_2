...
function displayWeatherCondition(response) {
  ...
  document.querySelector("#temperatureMin").innerHTML = Math.round(
    response.data.main.temp_min
  );
  document.querySelector("#temperatureMax").innerHTML = Math.round(
...
function convertToFahrenheit(event) {
  ...
  let curTemp = temperatureElement.innerHTML;
  curTemp = Number(curTemp);
